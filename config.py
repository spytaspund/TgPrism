...
class Config():
    def __init__(self) -> None:
        ...
        self.PROXY_TYPE = getenv("PROXY_TYPE", "off").lower() 
        self.PROXY_ADDR = getenv("PROXY_ADDR", "127.0.0.1") 
        self.PROXY_PORT = int(getenv("PROXY_PORT", 1515))
        self.PROXY_SECRET = getenv("PROXY_SECRET", "") # only for MTProto
        
        self.SINGBOX_SUB = getenv("SINGBOX_SUB", "") 
